...
function Footer() {
  ...
  const serviceCodeBox = useRef<any>(null);
  const showServiceCode = () => {
    if (serviceCodeBox.current) {
      serviceCodeBox.current.innerText = "123-123";
    }
  };
  return (
    <FooterWrapper>
      ...
      <ServiceCodeBox>
        <span ref={serviceCodeBox} onClick={showServiceCode}>
          서비스 코드
        </span>
      </ServiceCodeBox>
      <FooterTextBox>
        ...
        <div>
          <a
            href="https://www.ftc.go.kr/bizCommPop.do?wrkr_no=1658700119"
            target="_blank"
          >
            공정거래위원회 웹사이트
          </a>
